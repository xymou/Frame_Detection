...
from myprompt.template.manual_template import ManualTemplate
from myprompt.verbalizer.manual_verbalizer import  ManualVerbalizer

import torch
from torch import nn

# implementation of Prompt-tuning(https://arxiv.org/pdf/2104.08691v1.pdf)
class PromptTuningTemplate(Template):
    r"""
