...
from myprompt.utils.utils import round_list
import numpy as np
...
class TokenizerWrapper:
    ...
    def tokenize_with_mask(self,
                           wrapperd_example: List[Dict])->InputFeatures:
        raise NotImplementedError
    ...
    def truncate_from_tail(input_dict: Dict,
        ...
        for key in input_dict:
            ...
            for i, part in enumerate(parts[::-1]):
                if len(parts)==0:
                    continue
                if shortenable_ids[-1-i][0]==0: #this part is not shortenable
                    continue
