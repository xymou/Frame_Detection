...
class PromptForContrastive(nn.Module):
    def __init__(self,
                 plm: PreTrainedModel, 
                 template: Template,
    ...
    def forward(self, batch: Union[Dict, InputFeatures]) -> torch.Tensor:
        ...
        label_words_logits, label_word_dist = self.verbalizer.process_outputs(outputs_at_mask, batch=batch)
        return label_words_logits, label_word_dist
