from myprompt.data import InputFeatures
import os
import torch
...
from myprompt.template import MixedTemplate
...
class PtuningTemplate(MixedTemplate):
    ...
    def process_batch(self, batch: Union[Dict, InputFeatures], diff=False) -> Union[Dict, InputFeatures]:
        r"""
